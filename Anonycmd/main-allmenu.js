...
const handler = async (m, { conn, isCreator, isPremium, prefix, pushname } = {}) => {
  ...
  headerType: 1,
    ...
    contextInfo: {
      ...
      forwardedNewsletterMessageInfo: {
        ...
        newsletterName: 'ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴀɴᴏɴʏᴍᴏᴜs ᴍᴇɴᴜ'
}
  }
}, { quoted: m })
}
...
[ *\`INFORMATION\`* ]
[✦] status bot: ${conn.public ? 'public' : 'self'}
[✦] version: 5.0.0
